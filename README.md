...
> **Note:** This branch is intended solely for collecting additional runtime statistics. As a result, performance may be significantly slower compared to other branches.
...
| -e           | --reverse_sorting                     | Set the sorting order to "reverse" (starting from smallest match first)                   |
| -E           | --inverse_sorting                     | Set the sorting order to "inverse" (a nonsensical heuristic matching smallest to largest) |
